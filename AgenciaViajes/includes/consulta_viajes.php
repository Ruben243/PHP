...
$datos = mysqli_query($agenciaviajes, "select * from viajes LIMIT 3");
...
while ($extra = $datos->fetch_array(MYSQLI_ASSOC)) {
    ...
    echo "</p><a class='btn btn-success btn-block' href='/layout/Viaje_indi.php?imagen=" . $extra['imagen']."'>Mas Informacion</a>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
}
